...
open class VGPlayerView: UIView {
    ...
    open var controlViewDuration : TimeInterval = 3.0  /// default 5.0
    ...
    open var bottomView : UIView = {
        let view = UIView()
        view.backgroundColor = .clear//#colorLiteral(red: 0, green: 0, blue: 0, alpha: 0)
        return view
    }()
...
//        topView.isHidden = false
        ...
        self.playButtion.isHidden = false
...
//        bottomView.addSubview(timeSlider)
        ...
        playButtion.setImage(VGPlayerUtils.imageSize(image: playImage!, scaledToSize: CGSize(width: 50, height: 50)), for: .normal)
        playButtion.setImage(VGPlayerUtils.imageSize(image: pauseImage!, scaledToSize: CGSize(width: 50, height: 50)), for: .selected)
...
//            guard let strongSelf = self else { return }
//            make.left.equalTo(strongSelf.closeButton.snp.left).offset(20)
